...
export declare module UI {
    ...
    abstract class Layout<T extends JControl> extends Control<defs.UI.IPage | T> implements defs.UI.IApp {
        protected OnPageChanging(e: bind.EventArgs<Page, Layout<any>>): void;
        protected OnPageChanged(e: bind.EventArgs<Page, Layout<any>>): void;
        static DPSelectedPage: bind.DProperty<Page, Layout<any>>;
        static DPCurrentModal: bind.DProperty<Modal, Layout<any>>;
        CurrentModal: Modal;
        SelectedPage: Page;
        static __fields__(): (bind.DProperty<Page, Layout<any>> | bind.DProperty<Modal, Layout<any>>)[];
        Name: string;
        abstract Foot: ServiceNavBar<IItem>;
        abstract SearchBox: ActionText;
        Pages: collection.List<Page>;
        protected abstract showPage(page: Page): any;
        Logout(): void;
        constructor(view: any);
        protected silentSelectPage(oldPage: Page, page: Page): void;
        Open(page: Page): void;
    ...
    class App extends Layout<Head<Page> | Page | QBar<IItem> | Foot | ContentControl | ServiceNavBar<IItem>> {
        private name;
        ...
        initialize(): void;
        HideTopNavBar(hide: boolean): void;
    ...
    abstract class AuthApp extends App {
        ...
        OnStatStatChanged: bind.EventListener<(auth: AuthApp, isLogged: boolean) => void>;
    }
    enum NotifyType {
        Focuse = 0,
        UnFocus = 1,
...
export declare module UI {
    ...
    class ExContextMenu extends JControl {
        ...
        handleEvent(e: MouseEvent): void;
        private OnContextMenu(target, dom, e);
        Close(): void;
    ...
    module help {
        function createHeader(hd: HTMLTableRowElement, cols: IColumnTableDef[]): HTMLTableRowElement;
...
export declare module UI.Modals {
    ...
    class EModalEditer<T extends bind.DObject> extends BasicModalEditor<T> {
        ...
        private backupData;
        private _isOpen;
        edit(product: T, isNew: boolean, action: EModalEditorCallback<T>, editable?: boolean): void;
        Open(): void;
        Close(msg: MessageResult): void;
