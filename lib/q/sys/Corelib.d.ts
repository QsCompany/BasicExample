...
export declare namespace helper {
    function TryCatch<T>(owner: any, Try: (...args: any[]) => T, Catch?: (e: Error) => T, params?: any[]): T;
}
...
export declare namespace attributes {
    ...
    function property1<PropertyType, ClassType>(options: {
        type: Function | reflection.GenericType | reflection.DelayedType;
        Name?: string;
...
export declare namespace bind {
    ...
    abstract class Scop extends bind.DObject {
        ...
        protected valueChanged(sender: bind.PropBinding, e: bind.EventArgs<any, any>): void;
        ...
        static GetScop1(s: string, scop?: Scop, bindingMode?: BindingMode, controller?: Controller): Scop;
        private static parse(s);
        private static simplePath;
    ...
    class StringScop extends bind.Scop {
        private sc;
        private pb;
        constructor(s: string, _parent: bind.Scop);
...
export declare namespace ScopicControl {
    type IControlCreater = (name: string, dom: Node, currentScop: bind.Scop, parentScop: bind.Scop, parentControl: UI.JControl, controller: bind.Controller, e: bind.IJobScop) => UI.JControl;
    function register(name: string, creator: IControlCreater): void;
    function create(name: string, dom: Node, currentScop: bind.Scop, parentScop: bind.Scop, parentControl: UI.JControl, controller: bind.Controller, e: bind.IJobScop): UI.JControl;
}
...
export declare namespace net {
    ...
    class RequestUrl implements IRequestUrl {
        ...
        timeout?: number;
        Url: string;
        constructor(_url: string, context: basic.IContext, Header?: IRequestHeader, Method?: net.WebRequestMethod, HasBody?: boolean);
    }
}
export declare namespace basic {
